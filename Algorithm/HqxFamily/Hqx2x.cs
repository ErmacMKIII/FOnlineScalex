...
namespace FOnlineScalex.Algorithm.HqxFamily
{
    ...
    {
        public static void Hqx2xMeth(Frame src, out Frame dst, bool wrapX = false, bool wrapY = false)
        {
            uint Xres, Yres;
            Xres = (uint)src.Width;
        ...
        public static void Hqx2xMeth(Bitmap src, out Bitmap dst, bool wrapX = false, bool wrapY = false)
        {
            uint Xres, Yres;
            Xres = (uint)src.Width;
            Yres = (uint)src.Height;

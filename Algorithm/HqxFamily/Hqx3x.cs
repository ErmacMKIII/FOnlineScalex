...
namespace FOnlineScalex.Algorithm.HqxFamily
{
    ...
    /// <summary>
    /// Maxim Stepin Hqx3x class
    /// </summary>
    public class Hqx3x : Hqx
    {
        public static void Hqx3xMeth(
                        ...
                        case 165:
                            {
                                ...
                                dst.SetPixel(dpIdx + dpL + dpL + 1, Interpolation.Mix3To1(w[4], w[7]));
                                dst.SetPixel(dpIdx + dpL + dpL + 2, Interpolation.Mix2To1To1(w[4], w[5], w[7]));
                                break;
                            }
                        case 2:
                        case 34:
                        ...
                        case 177:
                            {
                                ...
                                dst.SetPixel(dpIdx + dpL + dpL, Interpolation.Mix2To1To1(w[4], w[7], w[3]));
                                dst.SetPixel(dpIdx + dpL + dpL + 1, Interpolation.Mix3To1(w[4], w[7]));
                                dst.SetPixel(dpIdx + dpL + dpL + 2, Interpolation.Mix3To1(w[4], w[7]));
                                break;
                            }
                        case 192:
                        case 193:
                        ...
                        case 197:
                            {
                                ...
                                dst.SetPixel(dpIdx + dpL + dpL, Interpolation.Mix3To1(w[4], w[6]));
                                dst.SetPixel(dpIdx + dpL + dpL + 1, w[4]);
                                dst.SetPixel(dpIdx + dpL + dpL + 2, Interpolation.Mix3To1(w[4], w[5]));
                                break;
                            }
                        case 96:
                        case 97:
                        ...
                        case 81:
                            {
                                ...
                                else
                                {
                                    ...
                                    dst.SetPixel(dpIdx + dpL + dpL + 2, Interpolation.Mix2To7To7(w[4], w[5], w[7]));
                                }
                                break;
                            }
                        case 72:
                        ...
                        case 51:
                            {
                                ...
                                else
                                {
                                    ...
                                    dst.SetPixel(dpIdx + 2, Interpolation.MixEven(w[1], w[5]));
                                    dst.SetPixel(dpIdx + dpL + 2, Interpolation.Mix3To1(w[4], w[5]));
                                }
                                dst.SetPixel(dpIdx + dpL, Interpolation.Mix3To1(w[4], w[3]));
                                dst.SetPixel(dpIdx + dpL + 1, w[4]);
                        ...
                        case 178:
                            {
                                ...
                                else
                                {
                                    dst.SetPixel(dpIdx + 1, Interpolation.Mix3To1(w[4], w[1]));
                                    dst.SetPixel(dpIdx + 2, Interpolation.MixEven(w[1], w[5]));
                                    dst.SetPixel(dpIdx + dpL + 2, Interpolation.Mix3To1(w[5], w[4]));
                                    dst.SetPixel(dpIdx + dpL + dpL + 2, Interpolation.Mix2To1To1(w[4], w[5], w[7]));
                                }
                                dst.SetPixel(dpIdx, Interpolation.Mix3To1(w[4], w[0]));
                                dst.SetPixel(dpIdx + dpL, Interpolation.Mix3To1(w[4], w[3]));
                        ...
                        case 85:
                            {
                                ...
                                else
                                {
                                    ...
                                    dst.SetPixel(dpIdx + dpL + 2, Interpolation.Mix3To1(w[5], w[4]));
                                    dst.SetPixel(dpIdx + dpL + dpL + 1, Interpolation.Mix3To1(w[4], w[7]));
                                    dst.SetPixel(dpIdx + dpL + dpL + 2, Interpolation.MixEven(w[5], w[7]));
                                }
                                dst.SetPixel(dpIdx, Interpolation.Mix2To1To1(w[4], w[3], w[1]));
                                dst.SetPixel(dpIdx + 1, Interpolation.Mix3To1(w[4], w[1]));
                                dst.SetPixel(dpIdx + dpL, Interpolation.Mix3To1(w[4], w[3]));
                        ...
                        case 113:
                            {
                                ...
                                else
                                {
                                    dst.SetPixel(dpIdx + dpL + 2, Interpolation.Mix3To1(w[4], w[5]));
                                    dst.SetPixel(dpIdx + dpL + dpL, Interpolation.Mix2To1To1(w[4], w[7], w[3]));
                                    dst.SetPixel(dpIdx + dpL + dpL + 1, Interpolation.Mix3To1(w[7], w[4]));
                                    dst.SetPixel(dpIdx + dpL + dpL + 2, Interpolation.MixEven(w[5], w[7]));
                                }
                                dst.SetPixel(dpIdx, Interpolation.Mix2To1To1(w[4], w[3], w[1]));
                                dst.SetPixel(dpIdx + 1, Interpolation.Mix3To1(w[4], w[1]));
                        ...
                        case 170:
                            {
                                ...
                                {
                                    dst.SetPixel(dpIdx, Interpolation.MixEven(w[3], w[1]));
                                    dst.SetPixel(dpIdx + 1, Interpolation.Mix3To1(w[4], w[1]));
                                    dst.SetPixel(dpIdx + dpL, Interpolation.Mix3To1(w[3], w[4]));
                                    dst.SetPixel(dpIdx + dpL + dpL, Interpolation.Mix2To1To1(w[4], w[7], w[3]));
                                }
            ...
            )
        {
            ...
            Xres = (uint)src.Width;
            Yres = (uint)src.Height;
            dst = new Bitmap((int)Xres * 3, (int)Yres * 3);
            uint spIdx = 0, dpIdx = 0;
            uint dpL = Xres * 3;
                        ...
                        case 165:
                            {
                                ...
                                SetPixel(dst, dpIdx + dpL + dpL + 1, Interpolation.Mix3To1(w[4], w[7]));
                                SetPixel(dst, dpIdx + dpL + dpL + 2, Interpolation.Mix2To1To1(w[4], w[5], w[7]));
                                break;
                            }
                        case 2:
                        case 34:
                        ...
                        case 177:
                            {
                                ...
                                SetPixel(dst, dpIdx + dpL + dpL, Interpolation.Mix2To1To1(w[4], w[7], w[3]));
                                SetPixel(dst, dpIdx + dpL + dpL + 1, Interpolation.Mix3To1(w[4], w[7]));
                                SetPixel(dst, dpIdx + dpL + dpL + 2, Interpolation.Mix3To1(w[4], w[7]));
                                break;
                            }
                        case 192:
                        case 193:
                        ...
                        case 197:
                            {
                                ...
                                SetPixel(dst, dpIdx + dpL + dpL, Interpolation.Mix3To1(w[4], w[6]));
                                SetPixel(dst, dpIdx + dpL + dpL + 1, w[4]);
                                SetPixel(dst, dpIdx + dpL + dpL + 2, Interpolation.Mix3To1(w[4], w[5]));
                                break;
                            }
                        case 96:
                        case 97:
                        ...
                        case 81:
                            {
                                ...
                                else
                                {
                                    ...
                                    SetPixel(dst, dpIdx + dpL + dpL + 2, Interpolation.Mix2To7To7(w[4], w[5], w[7]));
                                }
                                break;
                            }
                        case 72:
                        ...
                        case 51:
                            {
                                ...
                                else
                                {
                                    ...
                                    SetPixel(dst, dpIdx + 2, Interpolation.MixEven(w[1], w[5]));
                                    SetPixel(dst, dpIdx + dpL + 2, Interpolation.Mix3To1(w[4], w[5]));
                                }
                                SetPixel(dst, dpIdx + dpL, Interpolation.Mix3To1(w[4], w[3]));
                                SetPixel(dst, dpIdx + dpL + 1, w[4]);
                        ...
                        case 178:
                            {
                                ...
                                else
                                {
                                    SetPixel(dst, dpIdx + 1, Interpolation.Mix3To1(w[4], w[1]));
                                    SetPixel(dst, dpIdx + 2, Interpolation.MixEven(w[1], w[5]));
                                    SetPixel(dst, dpIdx + dpL + 2, Interpolation.Mix3To1(w[5], w[4]));
                                    SetPixel(dst, dpIdx + dpL + dpL + 2, Interpolation.Mix2To1To1(w[4], w[5], w[7]));
                                }
                                SetPixel(dst, dpIdx, Interpolation.Mix3To1(w[4], w[0]));
                                SetPixel(dst, dpIdx + dpL, Interpolation.Mix3To1(w[4], w[3]));
                        ...
                        case 85:
                            {
                                ...
                                else
                                {
                                    ...
                                    SetPixel(dst, dpIdx + dpL + 2, Interpolation.Mix3To1(w[5], w[4]));
                                    SetPixel(dst, dpIdx + dpL + dpL + 1, Interpolation.Mix3To1(w[4], w[7]));
                                    SetPixel(dst, dpIdx + dpL + dpL + 2, Interpolation.MixEven(w[5], w[7]));
                                }
                                SetPixel(dst, dpIdx, Interpolation.Mix2To1To1(w[4], w[3], w[1]));
                                SetPixel(dst, dpIdx + 1, Interpolation.Mix3To1(w[4], w[1]));
                                SetPixel(dst, dpIdx + dpL, Interpolation.Mix3To1(w[4], w[3]));
                        ...
                        case 113:
                            {
                                ...
                                else
                                {
                                    SetPixel(dst, dpIdx + dpL + 2, Interpolation.Mix3To1(w[4], w[5]));
                                    SetPixel(dst, dpIdx + dpL + dpL, Interpolation.Mix2To1To1(w[4], w[7], w[3]));
                                    SetPixel(dst, dpIdx + dpL + dpL + 1, Interpolation.Mix3To1(w[7], w[4]));
                                    SetPixel(dst, dpIdx + dpL + dpL + 2, Interpolation.MixEven(w[5], w[7]));
                                }
                                SetPixel(dst, dpIdx, Interpolation.Mix2To1To1(w[4], w[3], w[1]));
                                SetPixel(dst, dpIdx + 1, Interpolation.Mix3To1(w[4], w[1]));
                        ...
                        case 170:
                            {
                                ...
                                {
                                    SetPixel(dst, dpIdx, Interpolation.MixEven(w[3], w[1]));
                                    SetPixel(dst, dpIdx + 1, Interpolation.Mix3To1(w[4], w[1]));
                                    SetPixel(dst, dpIdx + dpL, Interpolation.Mix3To1(w[3], w[4]));
                                    SetPixel(dst, dpIdx + dpL + dpL, Interpolation.Mix2To1To1(w[4], w[7], w[3]));
                                }

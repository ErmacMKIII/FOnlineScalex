...
namespace FOnlineScalex.Scalex
{
    public static class ScalexBitmap
    {
        ...
        /// <returns></returns>
        private static bool PixelRGBAEqual(Bitmap src, int px, int py, int tx, int ty, double deviation)
        {
            if (px == tx && py == ty)
            {
                return true;
        ...
        /// <param name="deviation">eqDiff tolerance (pixel difference), in range [0,1]</param>
        /// <returns></returns>
        private static bool PixelRGBEqual(Bitmap src, int px, int py, int tx, int ty, double deviation)
        {
            if (px == tx && py == ty)
            {
                return true;
        ...
        private static void Scalex2xRGBHelper(Bitmap src, ref Bitmap dst, int px, int py, double eqDiff, double neqDiff)
        {
            ...
            */
            ...
            if (!PixelRGBEqual(src, Bx, By, Hx, Hy, neqDiff) && !PixelRGBEqual(src, Dx, Dy, Fx, Fy, neqDiff))
            {
               ...
               if (PixelRGBEqual(src, Bx, By, Fx, Fy, eqDiff))
               {
               ...
               if (PixelRGBEqual(src, Dx, Dy, Hx, Hy, eqDiff))
               {
               ...
               if (PixelRGBEqual(src, Hx, Hy, Fx, Fy, eqDiff))
               {
